  ...
  config = {
    ...
    systemd = {
      user.tmpfiles.rules = mkIf (isLinux && isWorkstation) [
        "d ${config.home.homeDirectory}/Documents/docs 0755 - - - -"
        "d ${config.home.homeDirectory}/Documents/workspace 0755 - - - -"
        "d ${config.home.homeDirectory}/Documents/workspace/lab 0755 - - - -"
        "d ${config.home.homeDirectory}/Documents/studies 0755 - - - -"
        "d ${config.home.homeDirectory}/Videos/animes/movies 0755 - - - -"
        "d ${config.home.homeDirectory}/Videos/animes/series 0755 - - - -"
        "d ${config.home.homeDirectory}/Videos/animes/OVAs 0755 - - - -"
        "d ${config.home.homeDirectory}/Videos/series 0755 - - - -"
        "d ${config.home.homeDirectory}/Videos/movies 0755 - - - -"
        "d ${config.home.homeDirectory}/Videos/downloads 0755 - - - -"
        "d ${config.home.homeDirectory}/Videos/youtube 0755 - - - -"
        "d ${config.home.homeDirectory}/Music/playlists 0755 - - - -"
        "d ${config.home.homeDirectory}/Music/albums 0755 - - - -"
        "d ${config.home.homeDirectory}/Music/singles 0755 - - - -"
        "d ${config.home.homeDirectory}/Music/artists 0755 - - - -"
        "d ${config.home.homeDirectory}/Music/downloads 0755 - - - -"
        "d ${config.home.homeDirectory}/Documents/workspace/lab/vm/windows 0755 - - - -"
        "d ${config.home.homeDirectory}/Documents/workspace/lab/vm/linux 0755 - - - -"
        "d ${config.home.homeDirectory}/Documents/workspace/lab/vm/mac 0755 - - - -"
        "d ${config.home.homeDirectory}/Documents/workspace/lab/vm/nixos-desktop 0755 - - - -"
        "d ${config.home.homeDirectory}/Documents/workspace/lab/vm/nixos-console 0755 - - - -"
        "d ${config.home.homeDirectory}/Pictures/family 0755 - - - -"
        "d ${config.home.homeDirectory}/Pictures/backup 0755 - - - -"
        "d ${config.home.homeDirectory}/Pictures/phones 0755 - - - -"
        "d ${config.home.homeDirectory}/Pictures/screenshots 0755 - - - -"
        "d ${config.home.homeDirectory}/Pictures/thumbnails 0755 - - - -"
        "d ${config.home.homeDirectory}/Pictures/wallpapers 0755 - - - -"
        "d ${config.home.homeDirectory}/Pictures/resources 0755 - - - -"
        "d ${config.home.homeDirectory}/.dotfiles 0755 - - - -"
        "d ${config.home.homeDirectory}/.config/home-manager 0755 - - - -"
      ];
    };
    ...
    gtk = mkIf isWorkstation {
      gtk3 = {
        bookmarks = [
          ...
          "smb://sharecenter.home.lan/volume_2/Transmission/Volume_2 h2tb"
