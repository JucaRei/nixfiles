  ...
  config = {
    ...
    systemd = {
      user.tmpfiles.rules = mkIf (isLinux && isWorkstation) [
        ...
        "d ${config.home.homeDirectory}/Documents/workspace/lab/vm/windows 0755 ${username} users - -"
        "d ${config.home.homeDirectory}/Documents/workspace/lab/vm/linux 0755 ${username} users - -"
        "d ${config.home.homeDirectory}/Documents/workspace/lab/vm/mac 0755 ${username} users - -"
        "d ${config.home.homeDirectory}/Documents/workspace/lab/vm/nixos-desktop 0755 ${username} users - -"
        "d ${config.home.homeDirectory}/Documents/workspace/lab/vm/nixos-console 0755 ${username} users - -"
