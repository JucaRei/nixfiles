    ...
    waybar = {
      ...
      settings = [{
        ...
        "custom/network_traffic" = {
          ...
          "return-type" = "json";
          "format-ethernet" =
            "{icon} {ifname} ⇣{bandwidthDownBytes:>4} ⇡{bandwidthUpBytes:>4}";
        };
        "custom/playerctl#backward" = {
          "format" = "󰙣 ";
        ...
        in {
          ...
          "on-click-right" =
            "sleep 0.1 && ${cliphist-custom}/bin/cliphist-custom d";
          "on-click-middle" =
            "sleep 0.1 && ${cliphist-custom}/bin/cliphist-custom w";
          "tooltip" = "false";
        };
        "keyboard-state" = {
          "numlock" = true;
        ...
        "network" = {
          ...
          "format-disconnected" =
            "󰞃  Not connected"; # An empty format will hide the module.
