...
git clone --depth=1 -b newconfig --quiet https://github.com/JucaRei/nixfiles "\${HOME}/.dotfiles/nix-config"
...
nix run nixpkgs#home-manager -- switch --flake "\${HOME}/.dotfiles/nixfiles"
