...
in
{
  options.hardware.audio."pipewire".useLowLatencyPipewire = mkOption {
    type = types.bool;
    default = false;
  ...
  config = mkIf (cfg.manager == "pipewire") {
    ...
    boot = mkIf config.services.pipewire.enable {
            ...
            ++ [
              ...
              (pkgs.writeTextDir "share/wireplumber/wireplumber.conf.d/10-bluez.conf" ''
                monitor.bluez.properties = {
                  ...
                  bluez5.codecs = [sbc sbc_xq aac ldac aptx aptx_hd aptx_ll aptx_ll_duplex faststream ];
                  bluez5.enable-sbc-xq = true;
                  bluez5.enable-msbc = true;
                  bluez5.enable-hw-volume = true;
                  bluez5.hfphsp-backend = "native";
                  bluez5.a2dp.ldac.quality = "auto";  # or "hq", "sq", "mq"
