...
in
{
  ...
  config = mkIf cfg.enable {
    ...
    home = mkIf cfg.enable {
      ...
      packages = with pkgs; [
        (writeScriptBin "youtube_channel_archiver" ("#!${mypython}/bin/python3\n" + (builtins.readFile ../../../../resources/configs/yt-dlp-scripts/youtube_channel_archiver.py)))

        (writeScriptBin "single_song_downloader" (builtins.readFile ../../../../resources/configs/yt-dlp-scripts/single_song_downloader.sh))
      ];
    };
  };
}
