# { config, lib, pkgs, ... }:
# let
#   inherit (lib) mkIf mkEnableOption mkOption literalExample;
#   inherit (lib.types) str bool package;

#   cfg = config.system.services.polkit-agent;
# in
# {
#   options.system.services.polkit-agent = {
#     enable = {
#       type = bool;
#       default = false;
#       description = "Enable's service polkit agent";
#     };
#     package = mkOption {
#       type = package;
