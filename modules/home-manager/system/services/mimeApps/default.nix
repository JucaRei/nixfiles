    ...
    xdg =
      let
        associations = {
          ...
          "inode/mount-point" = cfg.defaultFileManager;
          ...
          ### Archives ###
          ################
          "application/warc" = cfg.defaultArchiver;
          "application/x-archive" = cfg.defaultArchiver;
          ...
          "application/x-lz4" = cfg.defaultArchiver;
          ...
          "application/x-lzop" = cfg.defaultArchiver;
          "application/x-rar" = cfg.defaultArchiver;
          "application/x-rpm" = cfg.defaultArchiver;
          "application/zstd" = cfg.defaultArchiver;
