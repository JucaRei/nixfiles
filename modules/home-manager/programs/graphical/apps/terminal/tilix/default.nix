...
let
  ...
  cfg = config.programs.graphical.apps.terminal.tilix;
in
{
  options = {
    programs.graphical.apps.terminal.tilix = {
      enable = mkEnableOption "Whether enables and apply tilix configurations";
    };
  };
