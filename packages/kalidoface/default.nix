...
let
  ...
  kalidoface-2d = with-meta (makeDesktopItem {
    ...
    exec = ''${firefox}/bin/firefox "https://kalidoface.com/?excalibur.app=true"'';
    icon = ./icon-2d.svg;
    type = "Application";
    categories = [ "Network" ];
    terminal = false;
  ...
  kalidoface-3d = with-meta (makeDesktopItem {
    ...
    exec = ''${firefox}/bin/firefox "https://3d.kalidoface.com/?excalibur.app=true"'';
    icon = ./icon-3d.svg;
    type = "Application";
    categories = [ "Network" ];
    terminal = false;
