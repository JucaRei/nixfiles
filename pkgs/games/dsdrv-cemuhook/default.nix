{ lib, fetchFromGitHub, bluez, python3 }:
...
python3.pkgs.buildPythonPackage {
  ...
  propagatedBuildInputs = with python3.pkgs; [ evdev pyudev ];

  buildInputs = [ bluez ];

  meta = {
    description =
      "A Sony DualShock 4 and DualSense userspace driver for Linux with basic support of cemuhook's UDP protocol";
