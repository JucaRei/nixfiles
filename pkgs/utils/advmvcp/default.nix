...
in stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    ...
    url =
      "ftp://ftp.gnu.org/gnu/${coreutils_upstream}/${coreutils_upstream}-${coreutils_version}.tar.xz";
  ...
  patches = [
    (fetchpatch {
      url =
        "https://raw.githubusercontent.com/${advcpmv_owner}/${name}/${patch_rev}/${name}-${advcpmv_version}-${coreutils_version}.patch";
