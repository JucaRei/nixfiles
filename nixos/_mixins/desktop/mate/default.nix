      ...
      dconf.profiles.user.databases = [
        {
          settings = with lib.gvariant; {
            ...
            "org/gnome/desktop/interface" = {
              ...
              monospace-font-name = "FiraCode Nerd Font Mono Medium 10";
            ...
            "org/gnome/desktop/wm/preferences" = {
              ...
              titlebar-font = "Work Sans Semi-Bold 9";
              titlebar-uses-system-font = false;
            };

            "org/gnome/evolution/mail" = {
              monospace-font = "FiraCode Nerd Font Mono Medium 10";
              search-gravatar-for-photo = true;
              show-sender-photo = true;
              variable-width-font = "Work Sans 10";
            };
            ...
            "org/mate/desktop/interface" = {
              ...
              icon-theme = "Papirus-Dark";
              monospace-font-name = "FiraCode Nerd Font Mono Medium 9";
            };
            ...
            "org/mate/marco/general" = {
              ...
              theme = "catppuccin-mocha-blue-standard";
              titlebar-font = "Work Sans Semi-Bold 10";
            };
            ...
            "org/mate/pluma" = {
              ...
              editor-font = "FiraCode Nerd Font Mono Medium 10";
              highlight-current-line = true;
              insert-spaces = true;
              print-font-body-pango = "FiraCode Nerd Font Mono Medium 10";
              print-font-header-pango = "Work Sans 9";
