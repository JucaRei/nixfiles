  ...
  outputs =
    { self, ... }@inputs:
      ...
      in
      {
        ...
        homeConfigurations = {
          # .iso images
          "nixos@iso-console" = helper.makeHome {
            hostname = "iso-console";
            username = "nixos";
          };
          "nixos@iso-gnome" = helper.makeHome {
            hostname = "iso-gnome";
            username = "nixos";
            desktop = "gnome";
          };
          "nixos@iso-mate" = helper.makeHome {
            hostname = "iso-mate";
            username = "nixos";
            desktop = "mate";
          };
          "nixos@iso-pantheon" = helper.makeHome {
            hostname = "iso-pantheon";
            username = "nixos";
            desktop = "pantheon";
          };
          # Workstations
          "juca@oldarch" = helper.makeHome {
            hostname = "oldarch";
            desktop = null;
          };
          "juca@phasma" = helper.makeHome {
            hostname = "phasma";
            desktop = "pantheon";
          };
          "juca@vader" = helper.makeHome {
            hostname = "vader";
            desktop = "pantheon";
          };
          "juca@shaa" = helper.makeHome {
            hostname = "shaa";
            desktop = "gnome";
          };
          "juca@tanis" = helper.makeHome {
            hostname = "tanis";
            desktop = "gnome";
          };
          # darwin systems
          "juca@momin" = helper.makeHome {
            hostname = "momin";
            platform = "aarch64-darwin";
            desktop = "aqua";
          };
          "juca@krall" = helper.makeHome {
            hostname = "krall";
          ...
          # Steam Deck
          "deck@steamdeck" = helper.makeHome {
            hostname = "steamdeck";
            username = "deck";
          };
          # VMs
          "juca@minimech" = helper.makeHome { hostname = "minimech"; };
          "juca@scrubber" = helper.makeHome {
            hostname = "scrubber";
            desktop = "pantheon";
          };
        ...
        nixosConfigurations = {
          ...
          iso-console = helper.makeSystem {
            hostname = "iso-console";
            username = "nixos";
          };
          iso-gnome = helper.makeSystem {
            hostname = "iso-gnome";
            username = "nixos";
            desktop = "gnome";
          };
          iso-mate = helper.makeSystem {
            hostname = "iso-mate";
            username = "nixos";
            desktop = "mate";
          };
          iso-pantheon = helper.makeSystem {
            hostname = "iso-pantheon";
            username = "nixos";
            desktop = "pantheon";
          };
          ...
          phasma = helper.makeSystem {
            hostname = "phasma";
            desktop = "pantheon";
          };
          vader = helper.makeSystem {
            hostname = "vader";
            desktop = "pantheon";
          };
          shaa = helper.makeSystem {
            hostname = "shaa";
            desktop = "gnome";
          };
          tanis = helper.makeSystem {
            hostname = "tanis";
            desktop = "gnome";
          };
          sidious = helper.makeSystem {
            hostname = "sidious";
            desktop = "gnome";
          };
          # Servers
        ...
        devShells = helper.forAllSystems (
          ...
          in
          {
            ...
            node = pkgs.callPackage ./shells/node.nix { inherit pkgs; };
            go = pkgs.callPackage ./shells/go.nix { inherit pkgs; };
            python = pkgs.callPackage ./shells/python.nix { inherit pkgs; };
            pythonVenv = pkgs.callPackage ./shells/pythonVenv.nix { inherit pkgs; };
            lint = pkgs.callPackage ./shells/lint.nix { inherit pkgs; };
          }
        );
